...
struct CrosswordMiniView: View {
    @StateObject private var logic = CrosswordMiniLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Crossword Mini").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "rectangle.split.3x3").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentNeon)
                Text("Crossword Mini").font(.title.bold()).foregroundColor(.white)
