...
struct MysteryBoxView: View {
    @StateObject private var logic = MysteryBoxLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Mystery Box").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "shippingbox.fill").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentGold)
                Text("Mystery Box").font(.title.bold()).foregroundColor(.white)
    ...
    private var gameView: some View {
        VStack(spacing: 16) {
            ...
            Image(systemName: "shippingbox.fill").font(.system(size: 80)).foregroundColor(GamingDesignTokens.accentGold)
        ...
        return ScrollView {
            VStack(spacing: 20) {
                ...
                VStack(spacing: 8) {
                    ...
                    statRow("Boxes Opened", "\(logic.boxesOpened)")
