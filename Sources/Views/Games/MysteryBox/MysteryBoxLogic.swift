...
final class MysteryBoxLogic: ObservableObject, GamesRewardable {
    let gameIdentifier = "mystery_box"
    ...
    @Published var balance = 500; @Published var boxesOpened = 0
    ...
    func startGame(difficulty: Int = 0) {
        ...
        totalRounds = 10 + difficulty * 5; round = 0; score = 0; boxesOpened = 0
    ...
    func openPrize() {
        ...
        round += 1; canOpen = false; boxesOpened += 1
    ...
    func finalReward() -> GameReward {
        ...
        if totalWon >= 2000 { badge = badge ?? "Mystery Box Tycoon" }
