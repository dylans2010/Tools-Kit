...
final class LuckyPickLogic: ObservableObject, GamesRewardable {
    let gameIdentifier = "lucky_pick"
    ...
    @Published var balance = 500; @Published var cardsPicked = 0
    ...
    func startGame(difficulty: Int = 0) {
        ...
        totalRounds = 10 + difficulty * 5; round = 0; score = 0; cardsPicked = 0
    ...
    func openPrize() {
        ...
        round += 1; canOpen = false; cardsPicked += 1
    ...
    func finalReward() -> GameReward {
        ...
        if totalWon >= 2000 { badge = badge ?? "Lucky Pick Tycoon" }
