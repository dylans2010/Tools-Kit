...
struct NonogramSolverView: View {
    @StateObject private var logic = NonogramSolverLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Nonogram Solver").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "tablecells").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentNeon)
                Text("Nonogram Solver").font(.title.bold()).foregroundColor(.white)
