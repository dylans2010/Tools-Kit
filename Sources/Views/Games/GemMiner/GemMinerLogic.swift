...
final class GemMinerLogic: ObservableObject, GamesRewardable {
    let gameIdentifier = "gem_miner"
    ...
    @Published var balance = 500; @Published var gemsMined = 0
    ...
    func startGame(difficulty: Int = 0) {
        ...
        totalRounds = 10 + difficulty * 5; round = 0; score = 0; gemsMined = 0
    ...
    func openPrize() {
        ...
        round += 1; canOpen = false; gemsMined += 1
    ...
    func finalReward() -> GameReward {
        ...
        if totalWon >= 2000 { badge = badge ?? "Gem Miner Tycoon" }
