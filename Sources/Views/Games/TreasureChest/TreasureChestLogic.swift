...
final class TreasureChestLogic: ObservableObject, GamesRewardable {
    let gameIdentifier = "treasure_chest"
    ...
    @Published var balance = 500; @Published var chestsOpened = 0
    ...
    func startGame(difficulty: Int = 0) {
        ...
        totalRounds = 10 + difficulty * 5; round = 0; score = 0; chestsOpened = 0
    ...
    func openPrize() {
        ...
        round += 1; canOpen = false; chestsOpened += 1
    ...
    func finalReward() -> GameReward {
        ...
        if totalWon >= 2000 { badge = badge ?? "Treasure Chest Tycoon" }
