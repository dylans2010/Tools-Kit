...
struct TreasureChestView: View {
    @StateObject private var logic = TreasureChestLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Treasure Chest").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "lock.fill").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentGold)
                Text("Treasure Chest").font(.title.bold()).foregroundColor(.white)
    ...
    private var gameView: some View {
        VStack(spacing: 16) {
            ...
            Image(systemName: "lock.fill").font(.system(size: 80)).foregroundColor(GamingDesignTokens.accentGold)
        ...
        return ScrollView {
            VStack(spacing: 20) {
                ...
                VStack(spacing: 8) {
                    ...
                    statRow("Chests Opened", "\(logic.chestsOpened)")
