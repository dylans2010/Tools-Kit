...
struct CrystalBallView: View {
    ...
    var body: some View {
        ...
        .navigationTitle("Crystal Ball").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "moon.stars.fill").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentGold)
                Text("Crystal Ball").font(.title.bold()).foregroundColor(.white)
    ...
    private var gameView: some View {
        VStack(spacing: 16) {
            ...
            Image(systemName: "moon.stars.fill").font(.system(size: 80)).foregroundColor(GamingDesignTokens.accentGold)
        ...
        return ScrollView {
            VStack(spacing: 20) {
                ...
                VStack(spacing: 8) {
                    ...
                    statRow("Predictions", "\(logic.predictions)")
