...
final class GachaRollLogic: ObservableObject, GamesRewardable {
    let gameIdentifier = "gacha_roll"
    ...
    @Published var balance = 500; @Published var rollsMade = 0
    ...
    func startGame(difficulty: Int = 0) {
        ...
        totalRounds = 10 + difficulty * 5; round = 0; score = 0; rollsMade = 0
    ...
    func openPrize() {
        ...
        round += 1; canOpen = false; rollsMade += 1
    ...
    func finalReward() -> GameReward {
        ...
        if totalWon >= 2000 { badge = badge ?? "Gacha Roll Tycoon" }
