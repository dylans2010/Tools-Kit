...
struct NineManMorrisView: View {
    @StateObject private var logic = NineManMorrisLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Nine Man Morris").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "circle.grid.3x3").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentNeon)
                Text("Nine Man Morris").font(.title.bold()).foregroundColor(.white)
