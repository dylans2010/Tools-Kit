...
struct LogicGatesView: View {
    @StateObject private var logic = LogicGatesLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Logic Gates").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "cpu").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentNeon)
                Text("Logic Gates").font(.title.bold()).foregroundColor(.white)
