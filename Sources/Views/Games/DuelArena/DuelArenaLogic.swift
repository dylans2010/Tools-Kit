...
final class DuelArenaLogic: ObservableObject, GamesRewardable {
    let gameIdentifier = "duel_arena"
    ...
    @Published var playerHP = 100; @Published var maxPlayerHP = 100
    ...
    @Published var duelsWon = 0; @Published var duelsLost = 0; @Published var bestReaction: Double = 999
    @Published var perfectDraws = 0; @Published var drawReady = false
    private var drawTime: Date?
    ...
    func startGame(difficulty: Int = 0) {
        ...
        playerHP = 100 + difficulty * 20; maxPlayerHP = playerHP
    ...
    func endTurn() {
        ...
        playerHP -= dmg; consecutiveKills = 0
    ...
    func finalReward() -> GameReward {
        ...
        if totalKills >= 25 { badge = "Duel Arena Champion" }
