...
struct PipeConnectView: View {
    @StateObject private var logic = PipeConnectLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Pipe Connect").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "arrow.triangle.branch").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentNeon)
                Text("Pipe Connect").font(.title.bold()).foregroundColor(.white)
