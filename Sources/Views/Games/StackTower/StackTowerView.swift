...
struct StackTowerView: View {
    @StateObject private var logic = StackTowerLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Stack Tower").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "square.stack.3d.up.fill").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentNeon)
                Text("Stack Tower").font(.title.bold()).foregroundColor(.white)
    ...
    private var gameView: some View {
        VStack(spacing: 10) {
            HStack {
                ...
                Spacer()
                Text("Blocks Stacked: \(logic.blocksStacked)").font(.caption.bold()).foregroundColor(GamingDesignTokens.successGreen)
                Spacer()
        ...
        return ScrollView {
            VStack(spacing: 20) {
                ...
                VStack(spacing: 8) {
                    ...
                    statRow("Blocks Stacked", "\(logic.blocksStacked)")
