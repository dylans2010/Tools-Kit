...
struct TowerOfHanoiView: View {
    @StateObject private var logic = TowerOfHanoiLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Tower of Hanoi").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "square.3.layers.3d").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentNeon)
                Text("Tower of Hanoi").font(.title.bold()).foregroundColor(.white)
