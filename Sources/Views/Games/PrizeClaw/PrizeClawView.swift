...
struct PrizeClawView: View {
    @StateObject private var logic = PrizeClawLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Prize Claw").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "hand.raised.fill").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentGold)
                Text("Prize Claw").font(.title.bold()).foregroundColor(.white)
    ...
    private var gameView: some View {
        VStack(spacing: 16) {
            ...
            Image(systemName: "hand.raised.fill").font(.system(size: 80)).foregroundColor(GamingDesignTokens.accentGold)
        ...
        return ScrollView {
            VStack(spacing: 20) {
                ...
                VStack(spacing: 8) {
                    ...
                    statRow("Prizes Won", "\(logic.prizesWon)")
