...
final class PrizeClawLogic: ObservableObject, GamesRewardable {
    let gameIdentifier = "prize_claw"
    ...
    @Published var balance = 500; @Published var prizesWon = 0
    ...
    func startGame(difficulty: Int = 0) {
        ...
        totalRounds = 10 + difficulty * 5; round = 0; score = 0; prizesWon = 0
    ...
    func openPrize() {
        ...
        round += 1; canOpen = false; prizesWon += 1
    ...
    func finalReward() -> GameReward {
        ...
        if totalWon >= 2000 { badge = badge ?? "Prize Claw Tycoon" }
