...
final class ColorMemoryLogic: ObservableObject, GamesRewardable {
    let gameIdentifier = "color_memory"
    ...
    private let medSizes = [Int]([5])
    private let hardSizes = [Int]([6])

    func startGame(difficulty: Int = 0) {
        self.difficulty = difficulty
        sequenceLength = difficulty == 0 ? 4 : (difficulty == 1 ? 5 : 6)
