...
final class FortressDefendLogic: ObservableObject, GamesRewardable {
    let gameIdentifier = "fortress_defend"
    ...
    @Published var wallHP = 200; @Published var maxWallHP = 200
    ...
    @Published var attackersDefeated = 0; @Published var arrowsUsed = 0
    ...
    func startGame(difficulty: Int = 0) {
        ...
        wallHP = 200 + difficulty * 20; maxWallHP = wallHP
    ...
    func endTurn() {
        ...
        wallHP -= dmg; consecutiveKills = 0
        streakMultiplier = max(1.0, streakMultiplier - 0.1)
        if wallHP <= 0 { wallHP = 0; won = false; phase = .results }
    }
    ...
    func finalReward() -> GameReward {
        ...
        if totalKills >= 25 { badge = "Fortress Defend Champion" }
