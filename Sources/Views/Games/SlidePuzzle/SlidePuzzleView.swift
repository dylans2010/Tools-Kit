...
struct SlidePuzzleView: View {
    @StateObject private var logic = SlidePuzzleLogic()
    ...
    var body: some View {
        ...
        .navigationTitle("Slide Puzzle").navigationBarTitleDisplayMode(.inline)
    ...
    private var lobbyView: some View {
        ScrollView {
            VStack(spacing: 20) {
                Image(systemName: "square.grid.3x3.fill").font(.system(size: 64)).foregroundColor(GamingDesignTokens.accentNeon)
                Text("Slide Puzzle").font(.title.bold()).foregroundColor(.white)
