        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    submissionField(label: "Listing Title", text: $draft.metadata.title, hint: "App Name")
                    submissionField(label: "Subtitle", text: $draft.metadata.subtitle, hint: "Brief summary")
    ...
    private var assetsStep: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                submissionField(label: "Icon URL (512x512 PNG)", text: $draft.assets.iconURL, hint: "HTTPS URL")
    ...
    private var supportStep: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                submissionField(label: "Support Email", text: $draft.supportConfig.supportEmail, hint: "email@example.com")
                submissionField(label: "Support Website", text: $draft.supportConfig.supportURL, hint: "https URL")
                submissionField(label: "Privacy Policy URL", text: $draft.supportConfig.privacyPolicyURL, hint: "https URL")
